...
public class Impressora extends AppCompatActivity {
    Spinner modeloImpressora;
    EditText textoMensagem;
    Button imprimirTexto, imprimirXml;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imprimirTexto = (Button) findViewById(R.id.imprimirTexto);
        imprimirXml = (Button) findViewById(R.id.imprimirXml);

        imprimirTexto.requestFocus();
    ...
    private void listeners(){
        ...
        imprimirTexto.setOnClickListener(v->{
            ImprimirTexto();
        });

        imprimirXml.setOnClickListener(v-> {
            ImprimirXML();
        });
    }
